...
const Login = () => {
    ...
    const { backendUrl, setIsLoggedin,getUserDate } = useContext(AppContent) // intracted with backend
                ...
                <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm shadow-xl'>
                    ...
                    <form onSubmit={onSubmitHandler}>
                        ...
                        <div className='mb-4 flex item-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                            ...
                            <input onChange={(e) => setEmail(e.target.value)} value={email} className='bg-transparent outline-none text-white' type='email' placeholder='Email id' />
                        </div>
