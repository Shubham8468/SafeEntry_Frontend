...
const Header = () =>{
    ...
    return (
       ...
       <img  src={assets.header_img}
        ...
        <h1 className='flex items-center gap-2 text-xl sm:text-3xl front-medium mb-2'>Hi {userData ? userData.name :'Devloper'}! <img className='w-8 aspect-square' src={assets.hand_wave}/></h1>
